...
* NIF: 79.368.440-V
* Dirección: Puerto Orduña 18, 48993 Getxo-Vizcaya, España
...
1.	Prestación de servicios jurídicos: Gestión del servicio solicitado.
2.	Gestión administrativa: Facturación, contabilidad y cumplimiento de obligaciones legales.
3.	Newsletter y Comunicaciones: Enviar información sobre novedades jurídicas, artículos del blog, vídeos e información comercial siempre que hayas dado tu consentimiento explícito.
4.	Consultas Web: Responder a las dudas planteadas a través de los formularios de contacto.

### 3. LEGITIMACIÓN
La base legal para el tratamiento de tus datos es:
* Ejecución de un contrato: Para la prestación de los servicios jurídicos encargados.
* Consentimiento del interesado: Para la suscripción a la newsletter, el envío de formularios o comentarios en el blog/vídeos.
* Cumplimiento de una obligación legal: Para la facturación y requerimientos de autoridades públicas.
* Interés Legítimo:  Para el caso de tratar datos de terceros sin su consentimiento.
...
### 5. CÓMO SE RECOGEN TUS DATOS 
Para la correcta prestación de los servicios jurídicos y la gestión de la web, se obtiene la información de las siguientes formas:
* Información que usted nos facilita directamente:
* Mediante formularios: Al rellenar el formulario de contacto, suscripción a la newsletter o comentarios en el blog.
* En la consulta profesional: Datos facilitados por email, teléfono o presencialmente (DNI, datos familiares, documentos de propiedad, etc.) necesarios para el encargo del  servicio profesional.
* Datos recogidos de forma automática:
* Durante la navegación por la web y blog, se pueden recoger datos a través de cookies (como la dirección IP, el tipo de navegador o la duración de la visita) siempre que hayas dado tu consentimiento previo. Esto incluye la interacción con nuestros vídeos integrados.
* Datos obtenidos de terceros (Fuentes externas): Dada la naturaleza de la abogacía, en ocasiones trataremos datos que no han sido facilitados directamente por ti, sino que proceden de:
* Registros Públicos: Registro Civil, de la Propiedad, Mercantil o de Últimas Voluntades.
* Organismos Públicos: Administraciones Tributarias o de la Seguridad Social.
* Otros intervinientes: Datos facilitados por la parte contraria, procuradores, notarios o juzgados en el marco del procedimiento judicial o extrajudicial.

...
E embora ambas sejam decisões inteligentes, muitos casais não assinam convenções.
Curioso, não é?
...
Sobretudo se o caminho passar pelo Tribunal.

## O problema não é o amor, é a falta de informação

Em Espanha continua a pensar-se que as convenções:

- “São para ricos”
- “É desconfiar do outro”
- “É pôr-se no pior cenário”


**Erro.**

Trata-se de uma **ferramenta de prevenção e planeamento**, como o teu plano de pensões ou os teus fundos de investimento.

A diferença é que afeta algo fundamental: a tua paz de espírito.

A tua tranquilidade não tem preço.

As convenções protegem-te caso a vida mude.

E, além disso, permitem-te decidir sobre o que é importante no momento mais adequado: quando tudo está bem.
...
Não posso terminar este post de outra forma que não seja pedindo-te desculpa. 

Porque a partir de agora já não podes dizer:

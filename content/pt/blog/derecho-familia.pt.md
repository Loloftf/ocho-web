...
* Quem decidirá por ti se não o puderes fazer?
  A procuração preventiva resolve essa situação.
* Como será gerido o teu património se a relação terminar?
  Podes acordá-lo em convenções matrimoniais.
* Como queres proteger os teus quando já não estiveres?
  Com um testamento personalizado.
...
E a minha resposta é a mesma: Não.

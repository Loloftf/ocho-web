...
1. Prestação de serviços jurídicos: Gestão do serviço solicitado.
2. Gestão administrativa: Faturação, contabilidade e cumprimento de obrigações legais.
3. Newsletter e Comunicações: Enviar informações sobre novidades jurídicas, artigos do blog, vídeos e informação comercial, desde que você tenha dado seu consentimento explícito.
4. Consultas Web: Responder às dúvidas apresentadas através dos formulários de contato.

### 3. LEGITIMAÇÃO
A base legal para o tratamento dos seus dados é:
* Execução de um contrato: Para a prestação dos serviços jurídicos encomendados.
* Consentimento do interessado: Para a subscrição da newsletter, o envio de formulários ou comentários no blog/vídeos.
* Cumprimento de uma obrigação legal: Para a faturação e requerimentos de autoridades públicas.
* Interesse Legítimo: Para o caso de tratar dados de terceiros sem o seu consentimento.
...
### 5. COMO OS SEUS DADOS SÃO RECOLHIDOS 
Para a correta prestação dos serviços jurídicos e a gestão do site, a informação é obtida das seguintes formas:
* Informação que você nos fornece diretamente:
* Mediante formulários: Ao preencher o formulário de contato, subscrição da newsletter ou comentários no blog.
* Na consulta profissional: Dados fornecidos por e-mail, telefone ou presencialmente (DNI, dados familiares, documentos de propriedade, etc.) necessários para a encomenda do serviço profissional.
* Dados recolhidos de forma automática:
* Durante a navegação pelo site e blog, podem ser recolhidos dados através de cookies (como o endereço IP, o tipo de navegador ou a duração da visita), desde que você tenha dado o seu consentimento prévio. Isto inclui a interação com os nossos vídeos integrados.
* Dados obtidos de terceiros (Fontes externas): Dada a natureza da advocacia, por vezes trataremos dados que não foram fornecidos diretamente por você, mas que provêm de:
* Registros Públicos: Registro Civil, da Propriedade, Comercial ou de Últimas Vontades.
* Organismos Públicos: Administrações Tributárias ou da Segurança Social.
* Outros intervenientes: Dados fornecidos pela parte contrária, solicitadores/procuradores, notários ou tribunais no âmbito do procedimento judicial ou extrajudicial.
